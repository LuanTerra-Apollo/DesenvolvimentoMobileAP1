  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.viewBottom}>
          ...
          <Text style={styles.bottomText}>New to Roll20?</Text>
          <Text style={[styles.bottomText, {marginTop: 0}]}><Text style={styles.bottomLink} onPress={() => { Linking.openURL('https://app.roll20.net/create-account')}}>Create an account</Text></Text>
